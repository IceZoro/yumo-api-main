...
const PageLayout = () => {
  ...
  useEffect(() => {
    ...
    let logo = localStorage.getItem('logo') || logoConfig.favicon;
    if (logo) {
  ...
  return (
    <Layout
      ...
      style={{
        ...
        overflow: isMobile ? 'visible' : (isCustomPage ? 'visible' : 'hidden'),
      }}
    >
      <Header
        style={{
      ...
      >
        ...
        >
          <Content
            style={{
              flex: '1 0 auto',
              overflowY: isMobile ? 'visible' : (isCustomPage ? 'auto' : 'hidden'),
