...
const CustomInputRender = (props) => {
  ...
  return (
    <div className='p-2 sm:p-4' ref={containerRef}>
      <div
        className='flex items-center gap-2 sm:gap-3 p-2 rounded-xl sm:rounded-2xl shadow-sm hover:shadow-md transition-shadow'
        style={{ border: '1px solid var(--semi-color-border)', background: 'var(--semi-color-bg-2)' }}
        onClick={onClick}
